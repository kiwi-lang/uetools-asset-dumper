...
# -*- coding: utf-8 -*-
"""
uetools_plugin documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, '..', 'uetools_plugin'))
...
htmlhelp_basename = 'uetools_plugin-doc'
...
latex_documents = [
    (master_doc, 'uetools_plugin.tex', u'uetools_plugin Documentation',
     u'authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'uetools_plugin', 'uetools_plugin Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'uetools_plugin', 'uetools_plugin Documentation',
     author, 'uetools_plugin', uetools.__descr__,
     'Miscellaneous'),
]
